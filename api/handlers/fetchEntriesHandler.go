...
func FetchEntriesHandler(w http.ResponseWriter, r *http.Request) {
	...
	// DEBUG print: print LogEntry structs
	// for _, le := range logEntries {
	// 	fmt.Fprintf(w, "<p>SeqNum: %s, TmStmp: %s, SrcIP: %s, Len: %s, Ttl: %s, Id: %s, Spt: %s, Dpt: %s, Window: %s</p>",
	// 		le.SeqNum, le.TmStmp.Format(time.RFC3339), le.SrcIP, le.Len, le.Ttl, le.Id, le.Spt, le.Dpt, le.Window) // DEBUG print
	// }
}
